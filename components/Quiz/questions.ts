export type QuizOption = { text: string; value: number };
...
export type QuizCategory = {
  ...
  category: string;
  description: string;
  suggestion: 'exercise' | 'all';
};

export const qtn: QuizQuestion[] = [
  {
    name: 's3',
  ...
  },
  {
    ...
    options: [
      { text: '1 to 3 hours', value: 0 },
      { text: '3 to 6 hours', value: 1 },
      { text: 'Greater than 6 hours', value: 2 },
      { text: 'Less than 1 hour', value: 3 },
    ],
    selected: null,
  },
  {
    ...
    options: [
      { text: 'Not like me at all', value: 0 },
      { text: 'Not like me', value: 1 },
      { text: 'Neutral', value: 2 },
      { text: 'Like me', value: 3 },
      { text: 'Very like me', value: 4 },
    ],
    selected: null,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Over half of the days', value: 2 },
      { text: 'Nearly everyday', value: 3 },
    ],
    selected: null,
  },
  {
